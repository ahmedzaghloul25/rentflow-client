...
import { MarkPaymentPaidData } from '@/src/types/payment';
import toast from 'react-hot-toast';
import { AxiosError } from 'axios';
import { GeneralError } from '@/src/types/common';

export const useContractPayments = ({ contractId, page, limit, filters }: { contractId: string, page: number, limit: number, filters: any }) => {
    return useQuery({
